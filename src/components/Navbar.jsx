...
const Navbar = ({ activePage, handleNavClick }) => {
  return (
    <div className="2xl:w-80 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-8 pl-6 pb-14 md:pb-0">
      <a
        href=""
        className="2xl:text-2xl xl:text-xl font-light text-red-500 mb-14 tracking-wider"
      >
        Apple Products
      </a>
      <div className="flex flex-col flex-grow ">
        {navItems.map((item, index) => (
          <a
            key={index}
            href="#"
            className="xl:w-36 lg:w-32 w-30 flex item-center justify-between my-3.5 text-left cursor-pointer"
